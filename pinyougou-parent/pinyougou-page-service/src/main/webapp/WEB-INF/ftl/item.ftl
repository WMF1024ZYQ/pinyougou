						...
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<#list specification.attributeValue as value>
									<dd><a class="{{isSelected('${specification.attributeName}','${value}')==true?'selected':''}}" href="javascript:;" ng-click="selectSpec('${specification.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
							</dl>
							</#list>
